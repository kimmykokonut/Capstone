                ...
                <Grid item key={index}>
                  <Card sx={{ maxHeight: '25vh', overflow: 'auto', backgroundColor: 'gold', border: '1px solid brown' }}>
                    <CardContent>
                      ...
                      <Typography variant="body1" sx={{ fontSize: '0.75rem' }}>{Math.round(((item.tempMin - 273.15) * 9 / 5 + 32))}°F</Typography>
                      <Typography variant="caption" sx={{ fontSize: '0.75rem' }}>Chance of rain: {(item.chanceRain * 100)}%</Typography><br />
                      <Typography variant="caption" sx={{ fontSize: '0.75rem' }}>Volume of rain: {(item.volumeRain * 0.0393701).toFixed(2)} inches</Typography><br />

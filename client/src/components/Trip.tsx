...
const Trip: React.FC<TripProps> = ({ id, date, general_location, restrictions, image_url, status }) => {
  ...
  return (
    <>
      <Card variant="outlined" sx={{ maxWidth: 350, m: '1rem', height: 'auto', backgroundColor: '#e0e0e0' }}>
        <CardMedia
          sx={{ height: 150 }}
          image={image_url}
        ...
        <CardContent
          ...
          sx={{ height: 150, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center' }}>
